...
class Colorize_NYU:
    ...
    def __call__(self, gray_image):
        ...
        #for label in range(1, len(self.cmap)):
        for label in range(0, len(self.cmap)-1):
            mask = gray_image[0] == label
            #mask = gray_image == label

            color_image[0][mask] = self.cmap[label+1][0]
            color_image[1][mask] = self.cmap[label+1][1]
            color_image[2][mask] = self.cmap[label+1][2]
